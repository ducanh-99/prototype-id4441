...
function Race(props) {
  ...
  return (
    <>
      <CModal show={invite} onClose={toggleInvite}>
        <CModalHeader closeButton>Mời bạn bè</CModalHeader>
        <CModalBody>
          <CCardText>
            Cung cấp URL này cho những người bạn muốn mời (có giá trị trong 24
            giờ):
          </CCardText>
          <CTooltip>
            <a href="#"> https://play.typeracer.com?rt=1nnu0z2e0y </a>
          </CTooltip>
        </CModalBody>
        <CModalFooter>
          <CButton color="primary" onClick={toggleInvite}>
            OK
          </CButton>{" "}
          {/*  */}
        </CModalFooter>
